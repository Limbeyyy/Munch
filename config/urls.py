...
# Speakers' photographs, while running from the development server. In
# production these are served by the web server in front of Django, the
# same way the static files are.
if settings.DEBUG:
